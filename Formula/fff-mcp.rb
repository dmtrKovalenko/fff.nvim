...
class FffMcp < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/dmtrKovalenko/fff.nvim/releases/download/v0.9.1/fff-mcp-aarch64-apple-darwin"
      sha256 "cee75793fff67b25b95303c4708ec88b2c707f5ca51df5975a77330fc169f6ab"
    end

    on_intel do
      url "https://github.com/dmtrKovalenko/fff.nvim/releases/download/v0.9.1/fff-mcp-x86_64-apple-darwin"
  ...
  on_linux do
    on_arm do
      url "https://github.com/dmtrKovalenko/fff.nvim/releases/download/v0.9.1/fff-mcp-aarch64-unknown-linux-gnu"
      sha256 "32cae6f55e0eed764d0ae150c2e6c9332608b131442b56a14d9afa9877294ef7"
    end

    on_intel do
      url "https://github.com/dmtrKovalenko/fff.nvim/releases/download/v0.9.1/fff-mcp-x86_64-unknown-linux-gnu"
