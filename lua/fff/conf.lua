...
local function init()
  ...
  local default_config = {
    ...
    grep = {
      ...
      -- Apply time_budget_ms even before anything matched. Off by default: plain/regex grep
      -- only starts counting once matches exist, so a zero-match query scans every candidate.
