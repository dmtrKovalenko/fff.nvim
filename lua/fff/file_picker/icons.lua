...
function M.get_directory_icon(dirname)
  ...
  elseif M.provider_name == 'mini.icons' then
    if M.provider.get then
      ...
      if provider_data and provider_data.glyph and provider_data.glyph ~= '' and provider_data.hl then
        return provider_data.glyph, provider_data.hl
      end
    end
  end
...
function M.get_icon(filename, extension, is_directory)
  ...
  elseif M.provider_name == 'mini.icons' then
    ...
    if icon_data and icon_data.glyph and icon_data.glyph ~= '' and icon_data.hl then
      return icon_data.glyph, icon_data.hl
    end
  end
