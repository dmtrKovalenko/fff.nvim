--- E2E test for live grep with prompt_position=top
--- Usage: nvim -l test_grep_top.lua
--- Opens the live grep picker at ~/dev/lightsource with top prompt

-- Add the plugin to runtimepath so require('fff') works
vim.opt.runtimepath:prepend(vim.fn.getcwd())

-- Minimal setup with top prompt
vim.g.fff = {
